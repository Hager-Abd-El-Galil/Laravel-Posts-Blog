...
<head>
    ...
    <link rel="icon" href="https://www.freepnglogos.com/uploads/panda-png/panda-clipart-bamboo-drawing-panda-bamboo-drawing-17.png">
    <!-- CSRF Token -->
            ...
            <div class="container">
                <div class="navbar-nav">
                    <a class="navbar-brand" href=" {{route('posts.index')}}">
                        <img src="https://www.freepnglogos.com/uploads/panda-png/panda-clipart-bamboo-drawing-panda-bamboo-drawing-17.png" width="50px" height="50px">
                    </a>
                </div>
                ...
                <div class="collapse navbar-collapse" id="navbarSupportedContent">
                    <div class="navbar-nav">
                        <a class="nav-link active align-middle fs-5" href="{{route('posts.index')}}">ALL POSTS</a>
                    </div>
                </div>
                <div class="collapse navbar-collapse" id="navbarSupportedContent">
                    <!-- Left Side Of Navbar -->
